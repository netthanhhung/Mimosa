<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SilverlightMinWidthResizer.ascx.cs" Inherits="Mimosa.Apartment.Web.UI.Shared.SilverlightMinWidthResizer" %>
<!--[if IE 6]>
